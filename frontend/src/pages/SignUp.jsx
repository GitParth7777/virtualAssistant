  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center ' style={{backgroundImage : `url(${bg})`}}>
        <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000069] backdrop-blur shadow-lg shadow-black flex flex-col justify-center items-center gap-[20px] px-[20px]' onSubmit={handleSignUp}>
            <h1 className='text-white font-semibold text-[30px] mb-[30px]'>Register to <span className='text-blue-400'>Virtual Assistant</span></h1>  
            
            <input type="text" placeholder='Enter your Name' name=""  className='w-full outline-none h-[60px] border-2 border-white bg-transparent text-white placeholder-gray-300 px-[20px] py-[10px] rounded-full text-[18px]' required onChange={(e)=>{setName(e.target.value)}} value={name}/>
            ...
            <button className='w-[150px] h-[60px] rounded-full bg-white font-semibold text-blac k text-[19px] mt-[30px]' disabled={loading}>{loading?"loading...":"Sign Up"}</button>
